...
let
  ...
  mpm-bin = stdenvNoCC.mkDerivation (finalAttrs: {
    inherit pname version;

    src = fetchurl {
      # https://www.mathworks.com/mpm/glnxa64/mpm redirects to here
      url = "https://ssd.mathworks.com/supportfiles/downloads/mpm/${finalAttrs.version}/glnxa64/mpm";
      hash = "sha256-1jmRH013DFdwdQoiNsCA0XtA3jK/rgVd2l5S7WreeG4=";
      executable = true;
    };
    dontUnpack = true;
