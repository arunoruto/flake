...
in
{
  ...
  options.programs.opencode = {
    ...
    settings = mkOption {
      type = lib.types.submodule {
        ...
        options.theme = mkOption {
          ...
          default = "opencode";
          example = "catppuccin";
          description = "The theme to use for opencode.";
        };
      };
      default = { };
    ...
    themes = mkOption {
      ...
      default = { };
      description = ''
        Custom themes for opencode. The attribute name becomes the command filename.
        Commands are stored in $XDG_CONFIG_HOME/opencode/themes/ directory.
